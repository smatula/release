...
echo "Archiving  /tmp/tests/ansible-tests/artifacts/ to ARTIFACT_DIR/dotnet-deploy-and-test"
mkdir -p $ARTIFACT_DIR/dotnet-deploy-and-test
cp -r /tmp/tests/ansible-tests/artifacts/  $ARTIFACT_DIR/dotnet-deploy-and-test/
